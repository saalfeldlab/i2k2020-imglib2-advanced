...
public interface Lazy {
	 ...
	 * {@link UnaryComputerOp}.  Use this method to use any unary op from
	 * ImageJ-Ops.  Since unary ops consume a source, you have to provide a
	 * source here.
	 *
	 * @param source
	...
	/**
	 * Create a memory {@link CachedCellImg} with a cell generator
	 * {@link UnaryComputerOp} provided by an {@link OpService}.  Use this
	 * method to use any unary op from ImageJ-Ops.  Since unary ops as well as
	 * the op service consume a source to do matching, you have to provide a
	 * source here.
	 *
	 * @param source
	 * @param sourceInterval
